...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Enter output dir name:");
        String outputdir = String.valueOf(sc.nextLine());
        Integer currentframe = 0;
        String filename;
        while (currentframe.equals(frames) == false) {
//            System.out.println("frame.length = " + frame.length);
//            System.out.println("frame[0].length = " + frame[0].length);
            currentframe++;
...
//            System.out.println(filename);
            ...
            String[][] frame = new String[wanted_height][wanted_width];
            Integer x = 0;
            Integer y = 0;
...
//                    System.out.println(finished_segments + " segments done out of " + total_segments + " segments");
            ...
            long_id = String.valueOf(currentframe);
            if (currentframe < 10000) {
                if (currentframe < 1000) {
                    if (currentframe < 100) {
                        if (currentframe < 10) {
            ...
            File output = new File("./" + outputdir + "/" + long_id + ".png");
            try {
